...
function App() {
  ...
  React.useEffect(() => {
    ...
    const descs = {
      uz: "Carbomax — Toshkentdagi avtomobil chexollari va aksessuarlar do'koni. Qo'lda tikilgan chexollar, pol qoplamalari, Magicar signalizatsiyalari. 1998-yildan beri.",
