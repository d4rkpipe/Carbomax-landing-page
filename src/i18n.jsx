  ...
  uz: {
    ...
    cats: {
      ...
      items: [
        ...
        { name: "Pollik qoplamalari", desc: "EVA, 3D va klassik kovrolinlar — avtomobilingiz modeliga aniq mos.", tag: "Omborda mavjud" },
    ...
    products: {
      ...
      filters: { all: "Barchasi", covers: "Chexollar", mats: "Pollik qoplamalari", acc: "Aksessuarlar" },
