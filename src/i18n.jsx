...
const I18N = {
  uz: {
    ...
    hero: {
      ...
      sub: "Xitoydan keltirilgan zamonaviy uskunalarda tayyorlangan chexollar, sifatli aksessuarlar va professional xizmat — bir joyda.",
  ...
  ru: {
    ...
    hero: {
      ...
      sub: "Чехлы, изготовленные на современном оборудовании из Китая, качественные аксессуары и профессиональный сервис — в одном месте.",
  ...
  en: {
    ...
    hero: {
      ...
      h1_b: "for your car",
      sub: "Seat covers made on modern equipment from China, quality accessories, and professional service — all in one place.",
