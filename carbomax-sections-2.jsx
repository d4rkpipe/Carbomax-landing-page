          ...
          <Reveal key={i} delay={i * 100}>
            <div style={{ display: "flex", flexDirection: "column", gap: 14, position: "relative" }}>
              <div style={{
                ...
                display: "flex", alignItems: "center", justifyContent: "center",
                fontFamily: "var(--font-display)", fontSize: 26, color: "var(--primary-bright)",
                position: "relative", zIndex: 2,
              }}>
                {i + 1}
              </div>
              <div>
                <h3 style={{ fontFamily: "var(--font-display)", fontSize: 28, margin: "0 0 8px", lineHeight: 1.05 }}>{s.title}</h3>
        ...
        {items.map((it, i) => (
          <Reveal key={i} delay={i * 80}>
            <div className="card" style={{ padding: "28px 28px 24px", display: "flex", flexDirection: "column", gap: 16, height: "100%" }}>
              ...
              <p style={{ fontFamily: "var(--font-display)", fontSize: 22, lineHeight: 1.3, margin: 0, flexGrow: 1 }}>
                "{it.quote}"
              </p>
        ...
        {sent ? (
          <Reveal>
            <div className="glass" style={{ padding: 40, textAlign: "center" }}>
              ...
              <div style={{ fontFamily: "var(--font-display)", fontSize: 28, lineHeight: 1.2 }}>{t("lead.success")}</div>
              ...
              <div style={{ borderBottom: "1px solid var(--border)" }}>
                <button
                  ...
                  <span style={{ display: "flex", alignItems: "baseline", gap: 16 }}>
                    ...
                    <span style={{ fontFamily: "var(--font-display)", fontSize: 22, lineHeight: 1.2 }}>{it.q}</span>
                  </span>
                  <span style={{
        ...
        <Reveal>
          <div className="card" style={{ padding: 32, display: "flex", flexDirection: "column", gap: 24, height: "100%" }}>
            <div>
              ...
              <div style={{ fontFamily: "var(--font-display)", fontSize: 22, marginTop: 6, lineHeight: 1.25 }}>{t("contact.address")}</div>
            </div>
            <div>
              <div className="eyebrow" style={{ fontSize: 10 }}>{t("contact.phoneLabel")}</div>
              <a href="tel:+998901234567" style={{ fontFamily: "var(--font-display)", fontSize: 22, marginTop: 6, lineHeight: 1.25, color: "var(--fg)", textDecoration: "none", display: "block" }}>+998 (90) 123-45-67</a>
            </div>
            <div>
        ...
        <Reveal>
          <div style={{
            ...
            <div style={{ position: "relative", zIndex: 1 }}>
              <div style={{ fontFamily: "var(--font-display)", fontSize: "clamp(28px, 3.5vw, 40px)", lineHeight: 1.1, maxWidth: 560 }}>{t("telegram.title")}</div>
      ...
      <div onClick={(e) => e.stopPropagation()} className="card" style={{ background: "var(--surface)", padding: 32, width: "100%", maxWidth: 480, position: "relative", maxHeight: "92vh", overflowY: "auto" }}>
        ...
        {sent ? (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <div style={{ fontFamily: "var(--font-display)", fontSize: 24, lineHeight: 1.2 }}>{t("booking.success")}</div>
          ...
          <>
            ...
            <div style={{ fontFamily: "var(--font-display)", fontSize: 32, lineHeight: 1.1, marginTop: 6 }}>{t("booking.title")}</div>
