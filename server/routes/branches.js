...
function normalize(d = {}) {
  return {
    ...
    hoursMon: clean(d.hoursMon, 60),
    hoursTue: clean(d.hoursTue, 60),
    hoursWed: clean(d.hoursWed, 60),
    hoursThu: clean(d.hoursThu, 60),
    hoursFri: clean(d.hoursFri, 60),
    hoursSat: clean(d.hoursSat, 60),
    hoursSun: clean(d.hoursSun, 60),
    lat: clean(d.lat, 40),
    lng: clean(d.lng, 40),
